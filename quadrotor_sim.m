function quadrotor_sim
	...
	uav_dynamics.v = [0; 3; 0];     %initial velocity of uav [m/s]
	uav_dynamics.x = [3; 0; -1];    %initial position of uav [m]
    ...
    for i = 1*div12:2*div12
        motor_efficiency_arr(1, i) = 0.5;
    end
    for i = 4*div12:5*div12
        motor_efficiency_arr(2, i) = 0.5;
    end
    for i = 7*div12:8*div12
        motor_efficiency_arr(3, i) = 0.5;
    end    
    for i = 10*div12:11*div12
	...
	for i = 1: ITERATION_TIMES
        ...
        % Add noise to motors
        f_magnitude = 10 / 4; % Distribute collective force to all motors
        f_motors = f_motors + noise_level * f_magnitude * randn(size(f_motors_ideal));
